<div class="card-deck mt-0">
	<div class="card quick-tool">
		...
		<div class="card-body">
			<h5 class="card-title"><a href="${pageContext.request.contextPath}/tools/quick-budget">View & Update Your Travel Junky Challenges</a></h5>
	...
	<div class="card quick-tool">
		...
		<div class="card-body">
			...
			<p class="card-text">Here you can view the list of rewards and use your points to redeem prizes</p>
		</div>
	</div>
